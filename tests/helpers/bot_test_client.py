...
Provides a high-level API for testing bot interactions without real Telegram API.
...
class BotTestClient:
    ...
    async def send_message(
        ...
        update = Update(
            update_id=len(self.received_updates) + 1,
            message=message
        )
...
async def create_test_client(bot: Bot, dispatcher: Dispatcher) -> BotTestClient:
