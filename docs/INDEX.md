...
### 🎯 Production
Документы по production готовности:
...
- **[AUTOMATION_SCRIPTS.md](production/AUTOMATION_SCRIPTS.md)** - Скрипты автоматизации
- **[COMPLETED_TASKS.md](production/COMPLETED_TASKS.md)** - Выполненные задачи
- **[REMAINING_TASKS.md](production/REMAINING_TASKS.md)** - Оставшиеся задачи
...
- **[PRODUCTION_AUDIT_REPORT.md](audit/PRODUCTION_AUDIT_REPORT.md)** - Аудит production
...
- **[DEPLOYMENT_REPORT.md](reports/DEPLOYMENT_REPORT.md)** - Отчет о деплое
- **[WORK_SESSION_REPORT.md](reports/WORK_SESSION_REPORT.md)** - Отчет о рабочей сессии
- **[BUSINESS_ROLES_ANALYSIS_REPORT.md](reports/BUSINESS_ROLES_ANALYSIS_REPORT.md)** - Анализ бизнес-ролей
- **[ORGANIZATION_2025-11-13.md](reports/ORGANIZATION_2025-11-13.md)** - Организация проекта
- **[WORK_REPORT_2025-11-16.md](reports/WORK_REPORT_2025-11-16.md)** - Рабочий отчет
- **[BUGS_REPORT.md](reports/BUGS_REPORT.md)** - Отчет об ошибках
...
- **[ENVIRONMENT_SETUP.md](guides/ENVIRONMENT_SETUP.md)** - Настройка окружения
- **[ADMIN_MANAGEMENT_SYSTEM.md](guides/ADMIN_MANAGEMENT_SYSTEM.md)** - Система управления админами
- **[ADMIN_SYSTEM_SUMMARY.md](guides/ADMIN_SYSTEM_SUMMARY.md)** - Резюме админ-системы
- **[ROI_SYSTEM_ADMIN_GUIDE.md](guides/ROI_SYSTEM_ADMIN_GUIDE.md)** - Руководство по ROI для админов
- **[ROI_SYSTEM_USER_GUIDE.md](guides/ROI_SYSTEM_USER_GUIDE.md)** - Руководство по ROI для пользователей
...
- **[STRUCTURE.md](architecture/STRUCTURE.md)** - Структура проекта
...
- **[INLINE_TO_REPLY_REFACTORING.md](development/INLINE_TO_REPLY_REFACTORING.md)** - Рефакторинг клавиатур
- **[AGENTAUTO_CONFIRMATION_PROMPT.md](development/AGENTAUTO_CONFIRMATION_PROMPT.md)** - Промпты для AgentAuto
- **[AGENTAUTO_DEPLOY_PROMPT.md](development/AGENTAUTO_DEPLOY_PROMPT.md)** - Промпты для деплоя
- **[GPT_REQUEST.md](development/GPT_REQUEST.md)** - Запросы к GPT
...
- **[DEPLOY_NOW.md](deployment/DEPLOY_NOW.md)** - Быстрый деплой
...
- **[ADMIN_SYSTEM_TESTING.md](testing/ADMIN_SYSTEM_TESTING.md)** - Тестирование админ-системы

### 🎯 Production
Production готовность и чеклисты:

- **[PRODUCTION_CHECKLIST.md](production/PRODUCTION_CHECKLIST.md)** - Чеклист production
- **[PRODUCTION_READINESS_ANALYSIS.md](production/PRODUCTION_READINESS_ANALYSIS.md)** - Анализ готовности
